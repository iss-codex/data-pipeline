...
Downloading Data
----------------
Data output from the CODEX data processing pipelines are stored and accessible through the `Solar Data Analysis Center (SDAC) <https://umbra.nascom.nasa.gov/codex/>`. CODEX data products can be downloaded either manually from SDAC, or queried and retrieved using the metadata within individual data products. 
